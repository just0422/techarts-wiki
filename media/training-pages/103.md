...
![Start Clock](/uploads/media-screenshots/103-start-clock.gif "Start Clock")
...
![Stage Message](/uploads/media-screenshots/103-stage-message.jpg "Stage Message")
...
![Stage Message Button](/uploads/media-screenshots/103-stage-message-button.jpg "Stage Message Button")

We can then type our message and click send. Once we do that, this will happen:
![Send Stage Message](/uploads/media-screenshots/103-send-stage-message.gif "Send Stage Message")
